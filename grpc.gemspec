...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/lib/event_engine/windows/windows_qos.cc )
  s.files += %w( src/core/lib/event_engine/windows/windows_qos.h )
  ...
  s.files += %w( src/core/lib/iomgr/qos_windows.cc )
  s.files += %w( src/core/lib/iomgr/qos_windows.h )
